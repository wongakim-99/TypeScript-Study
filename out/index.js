...
const arr_2 = [1, 2, 3, 4, 5, 6, 7, 712]; // 제네릭을 사용할 수 있음
console.log(arr);
console.log(arr_2);
/************************************************************************************************ */
// 6. 튜플(tuple) 튜플은 배열의 길이가 고정되고 각 요소의 타입이 지정되어 있는 배열 형식을 의미한다.
const arr_3 = ['hi', 10, 100, "jax"];
console.log(arr_3);
...
(function (Avengers) {
    ...
    Avengers[Avengers["Deadfool"] = 3] = "Deadfool";
})(Avengers || (Avengers = {}));
const hero1 = Avengers.Capt;
const hero2 = Avengers.IronMan;
const hero3 = Avengers.Thor;
const hero4 = Avengers.Deadfool;
...
(function (socialLogin) {
    socialLogin[socialLogin["kakao"] = 10] = "kakao";
    socialLogin[socialLogin["google"] = 20] = "google";
    socialLogin[socialLogin["github"] = 30] = "github";
    socialLogin[socialLogin["naver"] = 40] = "naver";
})(socialLogin || (socialLogin = {}));
const socialLogin_Kakao = socialLogin.kakao;
const socialLogin_Google = socialLogin.google;
const socialLogin_Github = socialLogin.github;
const socialLogin_Naver = socialLogin.naver;
...
const test_any2 = 'hi';
const test_any3 = 3;
const test_any4 = ['a', 2, 34, 4, 'string'];
